...
// BUG 1 REPARAT: major.deschis acum ['toate']
UNITATI.push({
    id: 'miercurea',
...
// BUG 2 REPARAT: structura feminin corectată (minor eliminat, tanar și major populate corect)
UNITATI.push({
    id: 'targsor',
...
// BUG 3 REPARAT: transferJudiciar.masculin elimina 'arestat' pentru minor/tanar, iar major ramane doar deschis/semideschis
UNITATI.push({
    id: 'timisoara',
